...
# OpenRouter LLM API
llm_api_url = "https://openrouter.ai/api/v1/chat/completions"  # Updated URL for OpenRouter API
...
def call_llm_api(text_data):
    headers = {
        ...
        'HTTP-Referer': 'https://yourwebsite.com',  # Optional, use your app URL if applicable
        'X-Title': 'Clinical Trial Extractor',      # Optional, use your app name
    }
...
if __name__ == "__main__":
    check_available_models()  # Check available models first
    all_trials = []
