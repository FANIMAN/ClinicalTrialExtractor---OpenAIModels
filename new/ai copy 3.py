...
Depending ont the above clinical trial data provided please answer the following questions and structure the response as outlined below:
...
""",
    ...
    print("Printing text for LLM end here-----------------")
